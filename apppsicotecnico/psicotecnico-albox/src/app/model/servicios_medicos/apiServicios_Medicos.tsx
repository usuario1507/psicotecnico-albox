import { IRespServicios_Medicos, IServicios_Medicos } from "@/app/interfaces/IServicios_Medicos";
import axios from "axios";

const apiBD = 'http://localhost:3001/api';
const apiServicios_Medicos = {
      
    listar: async (): Promise<IServicios_Medicos[]> => {
    ...
    new: async (Servicio_Medico:IServicios_Medicos): Promise<IRespServicios_Medicos> => {
        const ruta = `${apiBD}/servicio-medico`;
        console.log(ruta)
