...
export const AdministrativosGrid:FC<Props> = ({administrativos, columnas}) => {
    return (
        <>
        
        <div className="flex justify-center" style={{
            backgroundImage: "url('/patch-to-your-image.jpg')" }}>
        <div className="text-center text-black">
        <h1 className="text-2xl font-bold">Tabla de Administrativos</h1> 
        <Link color="foreground" href="/admin/administrativos/new">
           <Button color="primary">Crear Administrativo</Button>
        </Link>
               ...
               <tbody>
                  {
                    administrativos.map( (administrativo) => (
                           <tr className="bg-lime-500" key={ administrativo.id_administrativo }>
                              <td>{ administrativo.id_administrativo }</td>
                              <td>{ administrativo.nombre }</td>
                              <td>{ administrativo.apellido }</td>
                              <td>{ administrativo.correo_electronico }</td>
                              ...
                              <th>
                                <Image src={administrativo.foto} width={50} height={50} alt={"foto del administrativo"}/>
                              </th>
                           </tr>
                    )
                   )
